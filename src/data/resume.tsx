...
export const DATA = {
  ...
  description:
    "Love to code and design products! Transforming ideas into innovative, user-centric solutions. Blending creativity with technology.",
  // summary:
  //   "At the end of 2022, I quit my job as a software engineer to go fulltime into building and scaling my own SaaS businesses. In the past, [I pursued a double degree in computer science and business](/#education), [interned at big tech companies in Silicon Valley](https://www.youtube.com/watch?v=d-LJ2e5qKdE), and [competed in over 21 hackathons for fun](/#hackathons). I also had the pleasure of being a part of the first ever in-person cohort of buildspace called [buildspace sf1](https://buildspace.so/sf1).",
  summary:
    "I am a passionate [full-stack developer](#) and [UI/UX designer](#) with a keen eye for crafting intuitive and visually appealing digital experiences. With expertise in [building robust web and mobile applications](#), I combine technical skills with creative design to deliver seamless user experiences. Currently, I am expanding my knowledge by diving into the exciting field of [data science](#), aiming to blend my development expertise with data-driven insights to create innovative, impactful solutions.",
  avatarUrl: "/me.jpg",
  skills: [
    "React",
    "Next.js",
  ...
  work: [
    {
      company: "InnoWorks Software Solutions Pvt Ltd",
      href: "https://www.innoworks.tech/",
      badges: [],
      location: "Remote",
    ...
    },
    {
      company: "Brochill",
      badges: [],
      href: "https://brochill.com/",
      location: "Remote",
      title: "Graphic Designer",
      logoUrl: "/brochill-logo.png",
      start: "Jan 2022",
      end: "May 2022",
      description:
  ...
  education: [
    ...
    {
      school: "Keshava Reddy Educational Institutions",
      href: "https://keshavareddy.edu.in/",
      degree: "Secondary School Certificate",
      logoUrl: "/krs-logo.png",
      start: "2015",
      end: "2016",
    },
  ],
